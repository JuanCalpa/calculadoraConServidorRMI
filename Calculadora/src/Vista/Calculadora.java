    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        try {
            ...
            RMIDAO interfaz = (RMIDAO) registro.lookup("RemotoRMI");
                    ...
                    switch (signo){
            case "+": String suma = interfaz.sumar(numero1,numero2);
            pantalla.setText(suma);
        break;
            case "-": String resta = interfaz.restar(numero1, numero2);
            pantalla.setText(resta);
        break;
            case "*": String multi = interfaz.multiplicar(numero1, numero2);
            pantalla.setText(multi);
        break;
            case "/": String dividir = interfaz.dividir(numero1, numero2);
            pantalla.setText(dividir);
        break;
        
        }
           // String mensaje= interfaz.Mensaje("");
